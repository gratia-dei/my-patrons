...
const FILE_DATA_EVENTS_KEY = 'events';
const FILE_DATA_DATE_KEY = 'date';
const FILE_DATA_DEATH_KEY = 'death';
...
const getDataFileParams = function(cardType, data, dataPath) {
  ...
  if (cardType === CARD_TYPE_PATRONS || cardType === CARD_TYPE_GOD) {
    ...
    result[CARD_DATA_PARAMS_FIELD_DEATH] = DEATH_SYMBOL_CHARACTER + ' ' + getDeathDate(data[FILE_DATA_EVENTS_KEY][FILE_DATA_DEATH_KEY][FILE_DATA_DATE_KEY]);
