...
W pierwszej kolejności **powinien to być główny Patron Imienia informującej Cię właśnie osoby**, gdyż On już się tą osobą opiekuje w sposób szczególny. Gdybyś jednak już wcześniej zawierzył temu Patronowi swoją **Misję Apostoła** (dla innej osoby), wybierz Patrona lub ich grupę, **których imiona nie są znane**. Mogą to być np.: Wszyscy Święci, Święci Młodziankowie, Czterdziestu dwóch męczenników z Amorium, bezimienne dziecko Józefa i Wiktorii Ulmów, itp.
