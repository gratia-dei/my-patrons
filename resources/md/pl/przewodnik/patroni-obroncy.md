**UWAGA!** Aby użyć w praktyce i w pełni zrozumieć poniższy tekst, wymagana jest uprzednia znajomość obszarów [Moi Patroni](/guide/my-patrons) oraz [Sakramenty](/guide/sacraments).

---
W tym obszarze Twoim zadaniem będzie **poszukiwanie Patronów w przetrzeni Kościoła Rzymskokatolickiego**, w świętach, kalendarzach liturgicznych, ołtarzach i wielu innych płaszczyznach, które odsłonią przed Tobą nie tylko piękno **Kościoła**, ale przede wszystkim pozwolą doświadczyć znajdujących się w nim Bożych darów i mocy płynącej z regularnego przyjmowania **Sakramentów**.

Do zaproszenia Patrona Obrońcy danego dnia **wymagany** jest każdorazowo: udział we **Mszy Świętej**, przyjęcie **Komunii Świętej**, co oczywiście wymaga trwania w stanie **Łaski Uświęcającej**, w której utrzymaniu wielką pomocą będzie na pewno regularna **Spowiedź Święta** - powiedzmy **co miesiąc**, a na pewno nie rzadziej niż **co 40 dni**! Wybrany **Święty lub Błogosławiony** musi być wspominany przez Kościół w dniu zaproszenia go do grona **Patronów Obrońców**, dlatego czasem będzie trzeba na niego trochę poczekać.
...
## Jak często? ##
Można zaprosić tylko **jednego Patrona Obrońcę każdego dnia**!

## Jak zaprosić Patrona Opiekuna? ##
**Konkretnego Patrona możesz zaprosić do grona Twoich Obrońców tylko raz**! W tym celu kliknij w edytorze wyzwań przycisk **_„Dodaj nowe wyzwanie“_** i wybierz typ wyzwania: **_„Patron Obrońca [A]”_**.

## Krok 1: Weź udział we Mszy Świętej ##
**W dniu zaproszenia Patrona** należy **wziąć udział we Mszy Świętej** w dowolnym kościele rzymskokatolickim.

## Krok 2: Przyjmij Komunię Świętą ##
Także w **tym dniu** należy **przyjąć godnie Komunię Świętą** w dowolnej intencji, fizycznie albo (tylko z ważnych przyczyn) duchowo. Oczywista jest konieczność trwania w **Łasce Uświęcającej**!

## Krok 3: Pomódl się do Patrona Obrońcy ##
...
## Krok 4: Uzupełnij dowolne notatki ##
...
## Gratulacje! ##
Wybrany Patron dołączył właśnie **do grona Twoich Obrońców**!
...
## O świętach Patrona ##
Wspomniane wyzwanie **[DF] Święto Patrona**, polega na odkryciu nowego święta, powiązanego z nim **Patronem Obrońcą** lub **Osobą Boską**.
...
## Co dalej? ##
&gt;&gt;&gt; [Misje Odpustu](/guide/missions-of-indulgence) - zdobywaj odpusty, uwalniaj dusze czyśćcowe!
